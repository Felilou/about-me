<template>
  <div class="pt-3">
    <UCard>
      ...
      <p>
        <LanguageBox language-prop="at">
          Ordination DDr. Klaus Kotschy und Dr. Ali Al-Samarrae Goldeggasse 2/4, 1040 Wien 
        </LanguageBox>
        <LanguageBox language-prop="ee">
          Ordination DDr. Klaus Kotschy ja Dr. Ali Al-Samarrae, Goldeggasse 2/4, 1040 Viin
        </LanguageBox>
        <LanguageBox language-prop="ru">
          Ordination DDr. Klaus и Dr. Ali Al-Samarrae, Goldeggasse 2/4, 1040 Wien
        </LanguageBox>
        <LanguageBox language-prop="en">
          Ordination DDr. Klaus Kotschy and Dr. Ali Al-Samarrae, Goldeggasse 2/4, 1040 Vienna
        </LanguageBox>
      </p>
      <p class="m-0">
        <LanguageBox language-prop="at">
